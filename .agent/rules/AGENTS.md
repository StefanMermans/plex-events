...
### Key Terminology
- **Series**: Represents a series of movies, tv shows or a combination of both.
- **Release**: Represents a specific unit of media within a series, such as an episode or a movie.
...
- **Scrobble**: when a user finished watching a release. (watched 90% or more)
